...
public class UserInfoFrame implements ActionListener {
	...
	private void initialize() {
		...
		frmRegister.setBounds(800, 200, 450, 260);
	...
	// TODO
	/*
	 * private boolean checkCorrectness() { if (new
	 * String(passwordField.getPassword()).equals(new String(
	 * passwordField_1.getPassword()))) { return true; } return false; }
	 */
